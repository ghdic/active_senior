...
<jsp:include page="/view/navbar">
	<jsp:param name="title" value="교육 게시판 글쓰기"/>
...
<form action="/eduWriteAction" id="form" method="post" enctype="multipart/form-data">
...
<script src="/static/js/eduBbsWrite.js"></script>

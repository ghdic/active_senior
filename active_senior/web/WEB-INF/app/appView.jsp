...
<div class="board">
	...
	<%
		ArrayList<String> realFileNameArrayList = hireBbs.getRealFileNameArrayList();
		ArrayList<String> originalFileNameArrayList = hireBbs.getOriginalFileNameArrayList();

...
<jsp:include page="/view/navbar">
	<jsp:param name="title" value="공지&정보 게시판 글쓰기"/>
</jsp:include>
<%
...
<form action="/infoWriteAction" id="form" method="post" enctype="multipart/form-data">
...
<script src="/static/js/infoBbsWrite.js"></script>

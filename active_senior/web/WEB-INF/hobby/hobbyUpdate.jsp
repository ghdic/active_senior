...
<form action="/cmntyUpdateAction?bbsID=<%= bbsID %>" id="form" method="post" enctype="multipart/form-data">
	<table style="border: 1px solid #dddddd">
		<thead>
		<tr>
			<th class="write-title"><h2>취미 게시판 업데이트</h2></th>
		</tr>
		</thead>
		<tbody>
		<tr>
			<td><input type="text " placeholder="글 제목" id="bbsTitle" name="bbsTitle" value="<%= hobbyBbs.getBbsTitle() %>" autocomplete="off"></td>
		</tr>
		<tr>
			...
			<td>
				<div class="collocate-input">
					<div class="thumbnailSetting">
						<img src="<%=hobbyBbs.getBbsThumbnailPath() %>" alt="프로필" id="profilePreview">

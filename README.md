...
-   크롤링한 데이터는 수정시 summernote에 로드가 안된다.
-   파일 업로드, 태그, 키워드 부분에서 콤마로 파싱할때 에러가 날 수 있음

# 다못만든것

-   admin페이지 구현하다 말음..
-   고용게시판 제외 섬네일과 제목 컨텐츠만 글쓰기, 수정 할 수 있게 만들어둠.. 태그 키워드 파일업로드 x

# 프로젝트 세팅 방법

-   [☆active_senior.sql다운★](https://drive.google.com/file/d/14I-CtpZmCsZd0n2z7ZYcveQ9AkHBiGvg/view?usp=sharing)을 통해 데이터베이스 세팅
